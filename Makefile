MODULES := collection/ai_surface credential_access/cloud_metadata_check discovery/app_count discovery/mdm_policy_artifacts discovery/native_env discovery/netjoin_query discovery/os_version discovery/proxy_enum execution/firewall_rule
