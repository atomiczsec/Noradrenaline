...
: > "$POPULATED_HOME/Library/Preferences/com.apple.preference.security.plist"
...
assert_contains "$empty_output" "[i] Indicator: FileVault user recovery escrow preferences"
...
assert_contains "$populated_output" "[+] Indicator: FileVault user recovery escrow preferences"
